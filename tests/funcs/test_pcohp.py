...
def test_get_pcohp_1():
    # Bare minimum test for get_pcohp function - tests that it can run without error
    # and return a non-empty spectrum.
    edata = ElecData(EXAMPLE_CALC_DIRS_DIR / "N2_bare_min")
    _, spectrum = get_pcohp(edata, idcs1=0, orbs1="s", idcs2=1, orbs2="s")
